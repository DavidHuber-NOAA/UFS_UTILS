...
#-----------------------------------------------------------------------
# Driver script to create a cubic-sphere based model grid on S4.
#
...
export TMPDIR=/scratch/users/$LOGNAME/fv3_grid.$gtype
export out_dir=/scratch/users/$LOGNAME/C${res}
