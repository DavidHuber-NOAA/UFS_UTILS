...
if [ $target = wcoss_cray ]; then
 ...
 INCS="-I${NETCDF}/include"
 export LIBSM="${BACIO_LIB4} ${W3NCO_LIBd} ${IP_LIBd} ${SP_LIBd} ${NETCDF_LDFLAGS_F}"
 export FFLAGSM="-O3 -g -traceback -r8 -march=ivybridge -convert big_endian -fp-model precise  -assume byterecl ${INCS}"
